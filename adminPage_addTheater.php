    ...
    <?php if ($result->num_rows > 0): ?>
      <?php while ($row = $result->fetch_assoc()): ?>
        ...
        <div class="col-md-4 mb-4">
          <div class="card bg-dark text-white border-danger d-flex flex-column justify-content-between h-100">
            <div class="card-body">
            ...
            <div class="modal-content bg-dark text-white">
              <form action="update.php" method="POST">
                ...
                <div class="modal-body">
                  ...
                  <input type="hidden" name="redirect2" value="adminPage_addTheater.php">
                  <div class="mb-3">
            ...
            <div class="modal-content bg-dark text-white">
              <form action="delete.php" method="POST">
                ...
                <div class="modal-body text-center">
                  ...
                  <input type="hidden" name="redirect" value="adminPage_addTheater.php">
                </div>
                <div class="modal-footer">
...
<div class="modal fade" id="addTheaterModal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content bg-dark text-white">
      <form method="POST" action="adminPage_addTheater.php">
        <div class="modal-header">
  ...
  if ($conn->query($insertSql)) {
    ...
    echo "<script>
      Swal.fire({icon: 'success', title: 'Theater added successfully', timer: 1500, showConfirmButton: false})
        .then(() => window.location.href='adminPage_addTheater.php');
    </script>";
  } else {
