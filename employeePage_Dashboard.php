...
<nav class="navbar navbar-dark px-3 border-secondary rounded ">
  ...
  <div class="ms-auto">
    ...
    <a href="logout.php" class="btn btn-danger btn-sm"><i class="bi bi-box-arrow-right" alt="Logout"></i></a>
  </div>
</nav>
...
<div class="mb-5 text-center">
  ...
  <div class="row text-center">
    <div class="col border border-info rounded mx-5">
      <div class="row p-5 bg-dark text-white position-relative">
        ...
        <a href="employeePage_Movies.php" class="stretched-link"></a>
      </div>
    </div>
    ...
    <div class="col border border-info rounded mx-5">
      <div class="row p-5 bg-dark text-white position-relative">
        ...
        <a href="employeePage_addTheater.php" class="stretched-link "></a>
      </div>
    </div>
