...
<div class="mb-5 text-center">
  ...
  <form action="employeePage_Movies.php" method="post" class="mb-4 d-flex gap-2">
...
?>
        <div class="col-md-3 m-3 bg-dark border border-info rounded p-3 text-center text-white">
...
for ($i = 1; $i <= $totalPages; $i++) {
    ...
    echo "<li class='page-item $active'><a class='page-link' href='employeePage_Movies.php?page=$i'>$i</a></li>";
}
...
?>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content bg-dark text-white">
      ...
      <div class="modal-body">
        <form action="employeePage_Movies.php" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-4 text-center">
